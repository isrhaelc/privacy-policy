    ...
    return (
      <Container>
        ...
        <Text>
          ...
          Development;The Application is a tool to Covid-19 tracking
        </Text>
        <SubHeading>
          What information does the Application obtain and how is it used?
        </SubHeading>
        <SubHeading>User Provided Information:</SubHeading>
        <Text>
        ...
        <Text>
          ...
          contact us for help; (d) credit card information for purchase and use
          of the Application, and; (e) information you enter into our system
          when using the Application, such as contact information and project
        ...
        <Text>information about the location of your mobile device.</Text>
        <SubHeading>
        ...
        <List>
          ...
          <ListItem>
            if IC Development;is involved in a merger, acquisition, or sale of
        ...
        <SubHeading>Automatic Data Collection and Advertising</SubHeading>
        <Text>
          ...
          usage. We work with advertisers and third party advertising networks,
          who need to know how you interact with advertising provided in the
          Application which helps us keep the cost of the Application low.
          Advertisers and advertising networks use some of the information
          collected by the Application, including, but not limited to, the
          unique identification ID of your mobile device and your mobile
          telephone number. To protect the anonymity of this information, we use
          an encryption technology to help ensure that these third parties can’t
          identify you personally. These third parties may also obtain anonymous
          information about other applications you’ve downloaded to your mobile
          device, the mobile websites you visit, your non-precise location
          information (e.g., your zip code), and other non- precise location
          information in order to help analyze and serve anonymous targeted
          advertising on the Application and elsewhere. We may also share
          encrypted versions of information you have provided in order to enable
          our partners to append other available information about you for
          analysis or advertising related use.
        </Text>
        <Text>
          If you’d like to opt-out from third party use of this type of
          information to help serve targeted advertising, please visit the
          section entitled “Opt-out” below.
        </Text>
        <SubHeading>What are my opt-out rights?</SubHeading>
        <Text>
        ...
        <Text>
          ...
          opt-out via email, at isrhael.christian@gmail.com.
        </Text>
        <Text>
          Opt-out from the use of information to serve targeted advertising by
          advertisers and/or third party network advertisers: you may at any
          time opt-out from further allowing us to have access to your location
          data by describe
        </Text>
        <SubHeading>
        ...
        <Text>
          ...
          isrhael.christian@gmail.com and we will respond in a reasonable time.
        ...
        <Text>
          ...
          consent, he or she should contact us at isrhael.christian@gmail.com.
        ...
        <Text>
          ...
          via email at isrhael.christian@gmail.com.
        </Text>
      </Container>
    );
  }
